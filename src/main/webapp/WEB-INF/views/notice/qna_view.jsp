...
<a href="QuestionModifyView.bo?num=${boarddata.NOTICE_NUM}">
<button type = "button" class="btnalt">수 정</button>
</a>
<a href="QuestionDelete.bo?num=${boarddata.NOTICE_NUM}">
