...
<body>
		...
		<b>아이디</b>
		<input type="text" class="join" name="MEMBER_ID" placeholder="아이디" required maxLength="12"
		value ="${MEMBER_ID}">
		...
		<b>이메일 </b>
		<input type="text" class="join" name="MEMBER_EMAIL" readOnly
		value ="${MEMBER_EMAIL}">
		...
		<div class="clearfix">
			<button type="submit" id="submitbtn" class="submitbtn">회원가입</button>
