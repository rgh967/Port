...
insert into RECIPE
values(RECIPE_SEQ.nextval,'A1111','생선까스','regi_2/rep_food.jpg','어른아이 할거 없이 모두 좋아하는 생선까스입니다. <br>타르타르 소스와 함께 먹으면 더욱 맛있어요!',
...
insert into RECIPE
values(RECIPE_SEQ.nextval,'A1111','오븐 김치 그라탕','regi_5/rep_food.jpg','찬밥 활용 만점~~ <br>아이들이 좋아하는 간식으로 최고!',
...
insert into RECIPE
values(RECIPE_SEQ.nextval,'A2222','멘보샤','regi_7/rep_food.jpg','바삭한 식빵과 촉촉한 새우살의 만남! <br>어른들 술안주, 아이들 간식~ ',
