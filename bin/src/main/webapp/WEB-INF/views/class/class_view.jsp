...
<html>
	...
	<!-- 전체 화면 -->
	<body>
		<!-- 로그인한 MEMBER_ID, 후기등록/스크랩/구독에 사용 -->
		<input id="MEMBER_ID" type="hidden" name="MEMBER_ID" value="A1111">
		<input id="CLASS_ID" type="hidden" name="CLASS_ID" value="${class.CLASS_ID}">
			...
			<div class="view_area">
				...
				<aside class="aside" id="aside">
					...
					<div class="top">
						...
						<div class="basic_info">
							<h1><strong>${class.CLASS_TITLE}</strong></h1>
						...
						<div class="btn-area">
							<form id="scrapForm" action ="RecipeScrapAction.bo" method="post">
								...
								<button id="scrap" class="scrap">찜하기</button>
		      				</form>
	      					<form id="subscribeForm" action="MemberSubscribeAction.bo" method="post">
								...
								<button id="subscribe" class="subscribe">수강신청</button>
							</form>
						</div>
					</div>
				...
				<section class="section" id="section">
					...
					<div class="sec_review">
						<h3>후기</h3>
						<div class="review">
							<form action="CommentAdd.bo" method="post">
								<input type="hidden" name="RECIPE_ID" value="${recipe.RECIPE_ID}">
								...
								<button id="review_btn" class="review_btn" name="button" type="submit">등록</button>
								<br>
